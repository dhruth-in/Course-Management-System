...
def convertTo(
    src: cv2.GMat, rdepth: int, alpha: float = ..., beta: float = ...
) -> cv2.GMat: ...
...
def div(
    src1: cv2.GMat, src2: cv2.GMat, scale: float, ddepth: int = ...
) -> cv2.GMat: ...
def divC(
    src: cv2.GMat, divisor: cv2.GScalar, scale: float, ddepth: int = ...
) -> cv2.GMat: ...
def divRC(
    divident: cv2.GScalar, src: cv2.GMat, scale: float, ddepth: int = ...
) -> cv2.GMat: ...
...
def inRange(
    src: cv2.GMat, threshLow: cv2.GScalar, threshUp: cv2.GScalar
) -> cv2.GMat: ...
@_typing.overload
def infer(name: str, inputs: cv2.GInferInputs) -> cv2.GInferOutputs: ...
@_typing.overload
def infer(
    name: str, roi: cv2.GOpaqueT, inputs: cv2.GInferInputs
) -> cv2.GInferOutputs: ...
@_typing.overload
def infer(
    name: str, rois: cv2.GArrayT, inputs: cv2.GInferInputs
) -> cv2.GInferListOutputs: ...
def infer2(
    name: str, in_: cv2.GMat, inputs: cv2.GInferListInputs
) -> cv2.GInferListOutputs: ...
def integral(
    src: cv2.GMat, sdepth: int = ..., sqdepth: int = ...
) -> tuple[cv2.GMat, cv2.GMat]: ...
@_typing.overload
def kmeans(
    data: cv2.GMat,
...
def merge4(
    src1: cv2.GMat, src2: cv2.GMat, src3: cv2.GMat, src4: cv2.GMat
) -> cv2.GMat: ...
...
@_typing.overload
def threshold(
    src: cv2.GMat, thresh: cv2.GScalar, maxval: cv2.GScalar, type: int
) -> cv2.GMat: ...
@_typing.overload
def threshold(
    src: cv2.GMat, maxval: cv2.GScalar, type: int
) -> tuple[cv2.GMat, cv2.GScalar]: ...
