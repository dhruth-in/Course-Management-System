...
class PyParams:
    ...
    @_typing.overload
    def __init__(
        self, tag: str, model_path: str, bin_path: str, device: str
    ) -> None: ...
    @_typing.overload
    ...
    @_typing.overload
    def cfgReshape(
        self, new_shape_map: cv2.typing.map_string_and_vector_size_t
    ) -> PyParams: ...
    ...
    @_typing.overload
    def cfgScale(
        self, scale_map: cv2.typing.map_string_and_vector_float
    ) -> PyParams: ...
    @_typing.overload
